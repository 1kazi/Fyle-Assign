...
function prevPage() {
  if (currentPage > 1) {
    ...
    fetchAllReposOfUser('1kazi', currentPage);
  }
}
function changPagination() {

  fetchAllReposOfUser('1kazi', currentPageInput.value);
...
fetch('https://api.github.com/users?per_page=100000')
  ...
  .then(users => {
    ...
    userDropdown.addEventListener('change', () => {
      const selectedUser = userDropdown.value || "1kazi";
      searchval.value=""
